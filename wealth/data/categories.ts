...
export interface CategoryBase {
    ...
    name: string;
    type: "INCOME" | "EXPENSE";
    color: string; // Hexadecimal color codes
    icon: string;
  }
  
  // Extended interface for categories with subcategories
  export interface CategoryWithSubcategories extends CategoryBase {
    subcategories: string[];
  }
  
  // Union type for all categories
  export type Category = CategoryBase | CategoryWithSubcategories;
  ...
  // Reduce to map category IDs to their colors
